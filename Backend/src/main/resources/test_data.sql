...
-- 4000원대 메뉴 (20개)
('라면', '/api/image/test1', '4000', '라면', '계란', '김치', '단무지', '파', 1),
('참치김밥', '/api/image/test2', '4000', '참치김밥', '단무지', '우엉조림', '시금치나물', '계란말이', 2),
('주먹밥', '/api/image/test3', '4000', '주먹밥', '김가루', '참치마요', '단무지', '김치', 3),
('떡볶이', '/api/image/test4', '4000', '떡볶이', '어묵', '삶은계란', '오뎅국물', '김말이', 4),
('새우볶음밥', '/api/image/test5', '4000', '새우볶음밥', '계란스크램블', '단무지', '김치', '미역국', 5),
('멸치국수', '/api/image/test6', '4000', '소면', '멸치육수', '파', '김치', '단무지', 6),
('잔치국수', '/api/image/test7', '4000', '잔치국수', '멸치육수', '파', '김치', '단무지', 7),
('콩나물국밥', '/api/image/test8', '4000', '콩나물국', '밥', '김치', '깍두기', '계란', 8),
('비빔국수', '/api/image/test9', '4000', '비빔국수', '고추장양념', '오이채', '삶은계란', '김치', 9),
('어묵국', '/api/image/test10', '4000', '어묵국', '밥', '김치', '깍두기', '파', 10),
('만두국', '/api/image/test11', '4000', '만두국', '밥', '김치', '깍두기', '파', 11),
('육개장라면', '/api/image/test12', '4000', '육개장라면', '계란', '김치', '단무지', '파', 12),
('우동', '/api/image/test13', '4000', '우동', '어묵', '파', '김치', '단무지', 13),
('떡국', '/api/image/test14', '4000', '떡국', '만두', '김치', '깍두기', '계란지단', 14),
('김치라면', '/api/image/test15', '4000', '김치라면', '계란', '파', '김치', '단무지', 15),
('팟타이', '/api/image/test16', '4000', '쌀국수', '팟타이소스', '숙주나물', '라임', '땅콩가루', 16),
('베트남쌀국수', '/api/image/test17', '4000', '쌀국수', '육수', '숙주나물', '고수', '라임', 17),
('미역국밥', '/api/image/test18', '4000', '미역국', '밥', '김치', '깍두기', '참기름', 18),
('볶음우동', '/api/image/test19', '4000', '볶음우동', '야채', '어묵', '김치', '단무지', 19),
('순대국', '/api/image/test20', '4000', '순대국', '밥', '김치', '깍두기', '새우젓', 20),

-- 5500원대 메뉴 (15개)
('된장찌개정식', '/api/image/test21', '5500', '된장찌개', '밥', '김치', '시금치나물', '계란후라이', 21),
('김치찌개정식', '/api/image/test22', '5500', '김치찌개', '밥', '깍두기', '콩나물무침', '계란말이', 22),
('순두부찌개정식', '/api/image/test23', '5500', '순두부찌개', '밥', '김치', '시금치나물', '계란찜', 23),
('부대찌개정식', '/api/image/test24', '5500', '부대찌개', '밥', '김치', '콩나물무침', '계란', 24),
('미역국정식', '/api/image/test25', '5500', '미역국', '밥', '김치', '시금치나물', '계란후라이', 25),
('콩나물국정식', '/api/image/test26', '5500', '콩나물국', '밥', '김치', '무생채', '계란말이', 26),
('계란찜정식', '/api/image/test27', '5500', '계란찜', '밥', '김치', '시금치나물', '미역국', 27),
('시금치된장국정식', '/api/image/test28', '5500', '시금치된장국', '밥', '김치', '콩나물무침', '계란후라이', 28),
('열무국수정식', '/api/image/test29', '5500', '열무국수', '밥', '김치', '깍두기', '계란지단', 29),
('물냉면', '/api/image/test30', '5500', '물냉면', '냉면육수', '오이', '계란', '배', 30),
('비빔냉면', '/api/image/test31', '5500', '비빔냉면', '고추장양념', '오이', '계란', '배', 31),
('온면', '/api/image/test32', '5500', '온면', '따뜻한육수', '파', '김치', '단무지', 32),
('막국수', '/api/image/test33', '5500', '막국수', '비빔양념', '오이', '계란', '김치', 33),
('메밀국수', '/api/image/test34', '5500', '메밀국수', '육수', '파', '김치', '단무지', 34),
('함흥냉면', '/api/image/test35', '5500', '냉면', '냉면육수', '오이', '계란', '배', 35),

-- 7000원대 메뉴 (15개)
('불고기정식', '/api/image/test36', '7000', '불고기', '밥', '김치', '콩나물무침', '된장국', 36),
('제육볶음정식', '/api/image/test37', '7000', '제육볶음', '밥', '상추쌈', '콩나물무침', '된장국', 37),
('생선구이정식', '/api/image/test38', '7000', '고등어구이', '밥', '김치', '콩나물무침', '된장국', 38),
('돈까스정식', '/api/image/test39', '7000', '등심돈까스', '양배추샐러드', '밥', '김치', '된장국', 39),
('치킨까스정식', '/api/image/test40', '7000', '치킨까스', '양배추샐러드', '밥', '김치', '콘스프', 40),
('함박스테이크정식', '/api/image/test41', '7000', '함박스테이크', '양파소스', '밥', '샐러드', '콘스프', 41),
('닭갈비정식', '/api/image/test42', '7000', '닭갈비', '밥', '상추쌈', '콩나물무침', '된장국', 42),
('오징어볶음정식', '/api/image/test43', '7000', '오징어볶음', '밥', '상추쌈', '콩나물무침', '된장국', 43),
('두부김치정식', '/api/image/test44', '7000', '두부김치', '밥', '미역국', '계란찜', '오이무침', 44),
('계란말이정식', '/api/image/test45', '7000', '계란말이', '밥', '김치', '시금치나물', '된장국', 45),
('갈비탕정식', '/api/image/test46', '7000', '갈비탕', '밥', '김치', '오이무침', '계란찜', 46),
('비빔밥정식', '/api/image/test47', '7000', '비빔밥', '고추장', '나물5종', '계란후라이', '된장국', 47),
('쌈밥정식', '/api/image/test48', '7000', '쌈밥', '쌈장', '상추쌈', '고기볶음', '된장국', 48),
('삼겹살정식', '/api/image/test49', '7000', '삼겹살', '밥', '상추쌈', '콩나물무침', '된장국', 49),
('닭볶음탕정식', '/api/image/test50', '7000', '닭볶음탕', '밥', '김치', '콩나물무침', '계란찜', 50);
